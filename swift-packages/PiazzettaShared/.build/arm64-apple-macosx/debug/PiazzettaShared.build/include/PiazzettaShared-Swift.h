...
#ifndef PIAZZETTASHARED_SWIFT_H
#define PIAZZETTASHARED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PiazzettaShared",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15PiazzettaShared11AIAssistant")
...
@interface AIAssistant (SWIFT_EXTENSION(PiazzettaShared)) <ASWebAuthenticationPresentationContextProviding>
