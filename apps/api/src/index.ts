...
import { registerDashboardRoutes } from './stats/dashboard.routes';
import { registerStaffRoutes } from './staff/staff.routes';
import { registerStaffSchedulingRoutes } from './staff/scheduling.routes';
import { registerMarketingRoutes } from './marketing/marketing.routes';
import { registerAccountingRoutes } from './accounting/accounting.routes';
...
import { registerAiPreferenceRoutes } from './ai/ai-preferences.routes';
import { registerMenuAddOnRoutes } from './menu-addons/menu-addons.routes';
import { registerStaffNoteRoutes } from './staff/staff-notes.routes';
...
import { registerEntitlementRoutes, requireModule } from './entitlement/entitlement.routes';
import { getLogger, requestLogger, errorLogger } from './security/logger';
import { rateLimit, resolveRateLimitStore, loginKeyFn, type RateLimitStore } from './security/rate-limit';
import { getKdsWebSocket } from './realtime/kds-ws';
