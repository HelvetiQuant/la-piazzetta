...
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_col_009', 'venue_piazzetta', 'COL-009', 'Caffè shakerato', 'colazione', 400, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
...
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_col_030', 'venue_piazzetta', 'COL-030', 'Centrifughe', 'colazione', 500, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
...
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_col_034', 'venue_piazzetta', 'COL-034', 'Tortino', 'colazione', 400, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
...
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_bib_003', 'venue_piazzetta', 'BIB-003', 'Bibite in lattina', 'bibite', 350, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_bib_004', 'venue_piazzetta', 'BIB-004', 'Succhi di frutta', 'bibite', 350, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
INSERT INTO "Product" ("id","venueId","code","name","category","priceCents","unit","createdAt","updatedAt") VALUES ('prod_bib_005', 'venue_piazzetta', 'BIB-005', 'Frullati di frutta fresca', 'bibite', 500, 'pz', now(), now()) ON CONFLICT ("venueId","code") DO UPDATE SET "name" = EXCLUDED."name", "category" = EXCLUDED."category", "priceCents" = EXCLUDED."priceCents", "unit" = EXCLUDED."unit", "updatedAt" = now();
